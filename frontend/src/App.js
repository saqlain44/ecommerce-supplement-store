      ...
      <main className='py-3' style={{
        ...
        <Container>
          ...
          <Route
            ...
            exact
          />
          <Route path='/collections/:collection' component={CollectionsScreen} exact />
          <Route path='/collections/:collection/page/:pageNumber' component={CollectionsScreen} exact />
